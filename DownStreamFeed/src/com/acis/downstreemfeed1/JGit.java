package com.acis.downstreemfeed1;
...
public class JGit {
	...
	public static void main(String[] args) {
		...
		try {
			...
			git.commit().setMessage("Added Comit Tags").call();

			/*
			 * //Add Remote RemoteAddCommand remoteadd = git.remoteAdd();
			 * remoteadd.setName("origin"); remoteadd.setUri(new
			 * URIish("https://github.com/Srikanth346/TestUpload.git"));
			 * remoteadd.call();
			 * 
			 * //Push Changes to Online Repository PushCommand push =
			 * git.push();
			 * push.setRemote("https://github.com/Srikanth346/TestUpload.git");
			 * push.setCredentialsProvider(new
			 * UsernamePasswordCredentialsProvider("srikanth.m5593@gmail.com",
			 * "Srik@nth.m5593")); push.call();
			 */
